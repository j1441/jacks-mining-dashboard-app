...
function classifyRoomReading(snapshot, thermo, idleMinutes, steadyMinutes) {
  ...
  if (hashing && fanMax >= 2000) {
    ...
    return { tempC: r1v(minInlet - runOff), reliable: flushed };
  }
  if (!hashing && fanMax < 100) {
    ...
    const cooled = (chipMax !== null && chipMax <= 45)
      && (idleMinutes === null || idleMinutes === undefined || idleMinutes >= 45);
    return { tempC: r1v(minInlet - idleOff), reliable: cooled };
  }
